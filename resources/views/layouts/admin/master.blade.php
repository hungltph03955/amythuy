    ...
    <div class="wrapper">
            ...
            <section class="sidebar">
                ...
                <li>
                    <a href="{{url('admin/sale')}}">
                        <i class="fa fa-circle-o"></i> Sale</a>
                </li>--}} {{--
                <li>
                ...
                <li>
                    <a href="{{url('admin/customer')}}">
                        <i class="fa fa-circle-o"></i> Customer</a>
                </li>--}} {{--
                <li>
                    <a href="{{url('admin/information')}}">
                        <i class="fa fa-circle-o"></i> Information</a>
                </li>--}} {{--
                <li>
                    <a href="{{url('admin/order')}}">
                        <i class="fa fa-circle-o"></i> Order</a>
                </li>--}} {{--

                <li>
                    <a href="{{url('admin/imagebanner')}}">
                        <i class="fa fa-circle-o"></i> Image Banner </a>
                </li>--}}
                    ...
                    <li class="treeview">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li class="treeview">
                                    <a href="">
                                        <i class="fa fa-circle-o"></i> Màu sắc
                                        <span class="pull-right-container">
                                            <i class="fa fa-angle-left pull-right"></i>
                                        </span>
                                    </a>
                                    <ul class="treeview-menu">
                                        <li>
                                            <a href="{{url('admin/color/list')}}">
                                                <i class="fa fa-circle-o"></i>Danh sách màu sắc</a>
                                        </li>
                                        <li>
                                            <a href="{{url('admin/color/add')}}">
                                                <i class="fa fa-circle-o"></i>Thêm màu sắc
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="treeview">
                                    <a href="#">
                                        <i class="fa fa-circle-o"></i> Kích cỡ
                                        <span class="pull-right-container">
                                            <i class="fa fa-angle-left pull-right"></i>
                                        </span>
                                    </a>
                                    <ul class="treeview-menu">
                                        <li>
                                            <a href="{{url('admin/sizes/list')}}">
                                                <i class="fa fa-circle-o"></i>Danhz sách kích cỡ</a>
                                        </li>
                                        <li>
                                            <a href="{{url('admin/sizes/add')}}">
                                                <i class="fa fa-circle-o"></i>Thêm kích cỡ
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="treeview">
                                    <a href="#">
                                        <i class="fa fa-circle-o"></i>Bộ sưu tập
                                        <span class="pull-right-container">
                                            <i class="fa fa-angle-left pull-right"></i>
                                        </span>
                                    </a>
                                    <ul class="treeview-menu">
                                        <li>
                                            <a href="{{url('admin/collections/list')}}">
                                                <i class="fa fa-circle-o"></i>Danh sách bộ sưu tập</a>
                                        </li>
                                        <li>
                                            <a href="{{url('admin/collections/add')}}">
                                                <i class="fa fa-circle-o"></i>Thêm bộ sưu tập</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="treeview">
                                    <a href="#">
                                        <i class="fa fa-circle-o"></i>Chất liệu
                                        <span class="pull-right-container">
                                            <i class="fa fa-angle-left pull-right"></i>
                                        </span>
                                    </a>
                                    <ul class="treeview-menu">
                                        <li>
                                            <a href="{{url('admin/materials/list')}}">
                                                <i class="fa fa-circle-o"></i>Danh sách chất liệu</a>
                                        </li>
                                        <li>
                                            <a href="{{url('admin/materials/add')}}">
                                                <i class="fa fa-circle-o"></i>Thêm chất liệu</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li class="treeview">
                                    <li>
                                        <a href="{{action('Admin\NewController@getNewsList')}}">
                                            <i class="fa fa-circle-o"></i>Danh sách
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ action('Admin\NewController@getNewsAdd') }}">
                                            <i class="fa fa-circle-o"></i>Thêm tin tức</a>
                                    </li>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li class="treeview">
                                    <li>
                                        <a href="{{action('Admin\ImagebannerController@index')}}">
                                            <i class="fa fa-circle-o"></i>Danh sách
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ action('Admin\ImagebannerController@create') }}">
                                            <i class="fa fa-circle-o"></i>Thêm ảnh
                                        </a>
                                    </li>
                                </li>
                            </ul>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li class="treeview">
                                    <li>
                                        <a href="{{action('Admin\InformationController@index')}}">
                                            <i class="fa fa-circle-o"></i>Danh sách
                                        </a>
                                    </li>
                            </ul>
                            ...
                            <li class="treeview">
                                ...
                                <ul class="treeview-menu">
                                    <li class="treeview">
                                        <li>
                                            <a href="{{action('Admin\AboutController@getAboutAdd')}}">
                                                <i class="fa fa-circle-o"></i>Giới thiệu</a>
                                        </li>
                                </ul>
                                </li>
                                ...
                                <li class="treeview">
                                    ...
                                    <ul class="treeview-menu">
                                        <li class="treeview">
                                            <li>
                                                <a href="{{action('Admin\UserController@getUsersList')}}">
                                                    <i class="fa fa-circle-o"></i>Danh sách
                                                </a>
                                            </li>
                                            <li>
                                                <a href="{{action('Admin\UserController@getUsersAdd')}}">
                                                    <i class="fa fa-circle-o"></i>Thêm quản trị</a>
                                            </li>
                                    </ul>
                                    </li>
                                    @endif
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2018
                <a href="{{route('homepage.index')}}">AmyThuy.</a>
            </strong>
        </footer>
