...
@section('content')
    ...
    <section class="content-header content-child">
        <h1>Thêm mới màu sắc sản phẩm
            <small>(Thêm mới)</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Quản trị hệ thống</a></li>
            <li><a href="#">Thêm mới phụ mục sản phẩm</a></li>
            <li class="active"><a href="#">Thêm mới màu sắc</a></li>
        </ol>
        <p></p>
    </section>
    <p></p>
            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <form role="form" method="POST" action="{{action('Admin\ColorController@postColorAdd')}}">
                            {{ csrf_field() }}
                            <div class="box-body">
