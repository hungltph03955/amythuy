        ...
        <div class="topbar">
            ...
            <div class="topbar-child1">
                <a href="index.html" class="logo">
                    <img src="images/icons/logoAmthy.png" alt="IMG-LOGO"/>
                </a>
            </div>
...
<section class="bg-title-page p-t-40 p-b-50 flex-col-c-m"
         style="background-image: url(images/charisse-kenion-340543-unsplash.png);">
        ...
        <div class="row">
            <div class="col-md-4 p-b-30">
                <div class="hov-img-zoom">
                    <img src="images/8.png" alt="IMG-ABOUT">
                </div>
            </div>
            ...
            <div class="col-md-8 p-b-30">
                ...
                <p class="p-b-28">
                    ...
                    Pellentesque porta est ac neque bibendum viverra. Vivamus lobortis magna ut interdum laoreet. Donec
                    gravida lorem elit, quis condimentum ex semper sit amet. Fusce eget ligula magna. Aliquam aliquam
                    ...
                    pellentesque, magna vel dictum rutrum, neque justo eleifend elit, vel tincidunt erat arcu ut sem.
...
<footer class="bg6">
    <div class="t-center p-l-15 p-r-15">
        <div>
            <a href="#">
                <img class="logoImagefoooter" src="images/icons/logoAmthy.png" alt="IMG-LOGO"/>
            </a>
        </div>
        <div class="flex-m p-t-30">
            <dvi class="logoAmthy-footer">
        ...
        <div class="flex-m logoAmthy-footer-Search">
        ...
        <div class="t-center s-text8 p-t-20">
            © AmyThuy 2018. All rights reserved.<i class="fa fa-heart-o"
                ...
                href="https://colorlib.com" target="_blank"> +84 94 1000 586</a>
        </div>
    </div>
</footer>
